...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    public static OkHttpClient getOkHttpClient(){
        Api retrofitManager = sRetrofitManager.get(HostType.WE_CHAT);
        if (retrofitManager == null) {
            retrofitManager = new Api(HostType.WE_CHAT);
            sRetrofitManager.put(HostType.WE_CHAT, retrofitManager);
        }
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(AppContext.getInstance()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
